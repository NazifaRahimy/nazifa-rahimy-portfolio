        ...
        <div name='home' className="w-full h-auto md:h-screen  bg-[linear-gradient(135deg,#fff8ec_0%,#f5d6a0_60%,#f0c97a_100%)]">
            <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full  px-4 pb-5 md:flex-row ">
                <div className="flex flex-col justify-center pt-20 md:pt-0  w-full md:w-3/5  h-full pr-5">
                    ...
                    <h4 className="text-3xl font-bold mt-5" data-aos="fade-right" data-aos-delay="800" >Build Modern, Responsive <span className=" text-[rgb(109,67,0)]">Websites</span> </h4>
                    <h4 className="text-3xl font-bold  " data-aos="fade-left" data-aos-duration="1000" data-aos-delay="900">That Elevate Your <span className="text-[#f0c97a]"> Online Presence</span></h4>
                ...
                <div className="md:w-2/5 flex items-center justify-center "  data-aos="zoom-in-left" data-aos-duration="2500">
